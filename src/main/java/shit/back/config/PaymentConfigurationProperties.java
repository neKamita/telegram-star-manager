...
public class PaymentConfigurationProperties {
    ...
    public boolean hasEnabledPaymentMethods() {
        return ton.getEnabled() || yookassa.getEnabled() ||
                qiwi.getEnabled() || sberpay.getEnabled();
    }
    ...
    public String[] getEnabledPaymentMethods() {
        ...
        if (ton.getEnabled())
            methods.add("TON");
        if (yookassa.getEnabled())
            methods.add("YooKassa");
        if (qiwi.getEnabled())
            methods.add("Qiwi");
        if (sberpay.getEnabled())
            methods.add("SberPay");
    ...
    public boolean isValidConfiguration() {
        ...
        if (ton.getEnabled() && (ton.getApiKey() == null || ton.getApiKey().isEmpty())) {
            return false;
        }

        if (yookassa.getEnabled() && (yookassa.getShopId() == null || yookassa.getShopId().isEmpty())) {
            return false;
        }

        if (qiwi.getEnabled() && (qiwi.getPublicKey() == null || qiwi.getPublicKey().isEmpty())) {
            return false;
        }

        if (sberpay.getEnabled() && (sberpay.getMerchantId() == null || sberpay.getMerchantId().isEmpty())) {
            return false;
        }
