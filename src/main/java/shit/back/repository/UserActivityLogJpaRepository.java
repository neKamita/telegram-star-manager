...
public interface UserActivityLogJpaRepository extends JpaRepository<UserActivityLogEntity, Long> {
    ...
    List<UserActivityLogEntity> findActivitiesBetween(@Param("fromTime") LocalDateTime fromTime, @Param("toTime") LocalDateTime toTime);
    ...
    Long countByActionTypesAndTimestampAfter(@Param("actionTypes") List<ActionType> actionTypes, @Param("fromTime") LocalDateTime fromTime);
